...
ffmpeg_darwin_x64=https://ffmpeg.zeranoe.com/builds/macos64/static/ffmpeg-"${ffmpeg_version}"-macos64-static.zip
...
mkdir -p "$OUT_DIR" &&
(cd "$OUT_DIR" &&
wget -O ffmpeg_darwin_x64.zip "${ffmpeg_darwin_x64}")
